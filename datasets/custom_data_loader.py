...
def benchmarkLoader(args):
    ...
    elif  args.benchmark == 'DiLiGenT_main_r2_2':
        from datasets.DiLiGenT_main_r2_2 import DiLiGenT_main
        test_set  = DiLiGenT_main(args, 'test')
    elif args.benchmark == 'Dragon':
        from datasets.Dragon import Dragon
        test_set = Dragon(args, 'test')
    else:

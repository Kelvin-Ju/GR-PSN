...
class RunModelOpts(BaseOpts):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--benchmark',   default='Dragon')
        self.parser.add_argument('--bm_dir',      default='./data/datasets/Images/dragon_s-9.90_x-000_y-180')
        self.parser.add_argument('--model',       default='GR_PSN_run')
        self.parser.add_argument('--test_batch',  default=1,    type=int)
        self.parser.add_argument('--mtrl_type',  default=1,    type=int)
        #### Display Arguments ####

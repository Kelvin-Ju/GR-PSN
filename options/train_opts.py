...
class TrainOpts(BaseOpts):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--noise',       default=0.001,  type=float)
        self.parser.add_argument('--color_aug',   default=True,  action='store_false') 

        #### Training Arguments ####
        self.parser.add_argument('--model',       default='GR_PSN')
        self.parser.add_argument('--solver',      default='adam', help='RAdam|adam|sgd')
        self.parser.add_argument('--milestones',  default=list(range(4,30,5)), nargs='+', type=int)
        ...
        self.parser.add_argument('--normal_w',   default=0.1)
